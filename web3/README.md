...
In order to get an URL you can head to https://developer.metamask.io/key/all-endpoints, create an account, connect your wallet and copy the etherum URL.

The private key given to hardhat corresponds to the private key of the wallet deploying the contract.

This the public adress of the V1 of the contract : 

0x1d96e1fB16193130141E92a8A7C6fe36cB8A346C